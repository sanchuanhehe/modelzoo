...
| Hi3403V100 | SVP_NNN    | SS928V100        | [推理环境准备](https://gitee.com/HiSpark/modelzoo/blob/master/docs/SS928V100%E5%BC%80%E5%8F%91%E7%8E%AF%E5%A2%83%E6%90%AD%E5%BB%BA.md) |6.10.t01spc030b660(请联系FAE获取)|  aarch64-mix210-linux-gcc |  linux  | SS928 V100R001C02SPC022 
...
2. 验证batch_size的om模型的性能，参考命令如下：
   ...
   - --input： 指定输入数据的列表文件路径（此场景下为单输入的配置文件，注意：循环次数通过修改该文件中的loop变量即可）。
