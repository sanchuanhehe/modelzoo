...
ResNet是残差网络(Residual Network)的缩写,该系列网络广泛用于目标分类等领域以及作为计算机视觉任务主干经典神经网络的一部分，典型的网络有ResNet50, ResNet101等。ResNet证明网络能够向更深（包含更多隐藏层）的方向发展。
- 参考实现：
...
2. 导出onnx文件。
    ...
    比如：`python ./script/pth2onnx.py ./model/resnet50-0676ba61.pth ./model/resnet50.onnx`
...
1. 精度验证。
    ...
    SVP_NNN平台上精度结果：
    ```
    {"title": "Overall statistical evaluation", "value": [{"key": "Number of images", "value": "50000"}, {"key": "Number of classes", "value": "1000"}, {"key": "Top1 accuracy", "value": "76.05%"}, {"key": "Top2 accuracy", "value": "85.93%"}, {"key": "Top3 accuracy", "value": "89.68%"}, {"key": "Top4 accuracy", "value": "91.63%"}, {"key": "Top5 accuracy", "value": "92.85%"}]}
    ```
    NNN平台上精度结果：
    ```
    {"title": "Overall statistical evaluation", "value": [{"key": "Number of images", "value": "50000"}, {"key": "Number of classes", "value": "1000"}, {"key": "Top1 accuracy", "value": "76.13%"}, {"key": "Top2 accuracy", "value": "86.0%"}, {"key": "Top3 accuracy", "value": "89.74%"}, {"key": "Top4 accuracy", "value": "91.63%"}, {"key": "Top5 accuracy", "value": "92.88%"}]}
    ```
...
调用ACL接口推理计算，ResNet50模型的性能和精度参考下列数据。
