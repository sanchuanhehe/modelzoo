...
1. 获取权重文件。
   ...
   点击 [链接](https://github.com/zzubqh/CrowdCount) 进入CrowdCount开源首页，下载模型权重文件mscnn_model_weights.h5。
...
1. 精度验证。
   ...
   python3 crowdcount_evaluate.py \
      --pred_txt_dir "../out/result_pc/txt" \
      --gt_mat "../../../../../datasets/CrowDensity/Crowdata/crow.mat" \
      --output_file "../out/result_pc/metrics_results.txt" 
   ```
